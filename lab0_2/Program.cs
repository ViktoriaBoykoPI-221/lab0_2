//Таблица содержит данные об итогах зашиты дипломных работ и включает фамилию, имя студента, группу и его оценку. Вывести данные о студентах, учащихся в заданной группе, получившие заданную оценку.
using System;
